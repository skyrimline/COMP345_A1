...
GameEngine::GameEngine()
{
    ...
    for (int i = 0; i < numOfPlayer; ++i)
    {
        ...
        switch(strategy){
            case 1:
                players[i]->setStrategy(new HumanPlayerStrategy());
                break;

            case 2:
                players[i]->setStrategy(new AggressivePlayerStrategy());
                break;

            case 3:
                players[i]->setStrategy(new BenevolentPlayerStrategy());
                break;

            case 4:
                players[i]->setStrategy(new NeutralPlayerStrategy());
                break;
        }
    }
